...
local getcustomassets = {
	...
	['newvape/assets/new/guivape.png'] = 'rbxassetid://115445464885750',
	...
	['newvape/assets/new/textvape.png'] = 'rbxassetid://115445464885750',
...
mainapi:CreateCategory({
	Name = 'Legit',
	Icon = getcustomasset('newvape/assets/new/legittab.png'),
	Size = UDim2.fromOffset(14, 14)
})
mainapi:CreateCategory({
	Name = 'Exploits',
...
general:CreateButton({
	...
	mainapi.Save = function() end
		...
		if shared.VapeDeveloper then
			...
			loadstring(game:HttpGet('https://raw.githubusercontent.com/zuyv/ZenV4/'..readfile('newvape/profiles/commit.txt')..'/loader.lua', true))()
		end
	end,
